...
class Dashboard extends React.Component {
  ...
  find_team_members = async () => {
    ...
    const response = await axios.get(
      `http://localhost:8080/api/login_incubetee/${user}`
    );
  ...
  onDaily = () => {
    ...
    this.setState({ goto: "http://localhost:3000/todo" });
  };
        ...
        <aside class="nav">
          ...
          <ul class="menu">
            ...
            <li class="menu__item" style={{ color: "black" }}>
              ...
              <a href={this.state.goto} onClick={this.onDaily}>
                Daily Updates
              </a>
            </li>
            <li class="menu__item" style={{ color: "black" }}>
          ...
          <div class="nav__logout">
            <a class="nav__link" href="#" style={{ color: "black" }}>
              ...
              <a href="http://localhost:3000/incubetee" onClick={this.onLogOut}>
                Logout
              </a>
            </a>
          </div>
            ...
            <div class="page">
              <button class="arrow-left">
                ...
                >
                  ...
                  />
                  <path
                    d="M22 23.557l-4.722-4.722L22 14.113 20.887 13l-5.278 5.278a.787.787 0 000 1.113l5.278 5.279L22 23.557z"
                    fill="#A4A8BD"
                  />
                </svg>
              </button>
              ...
              <button class="arrow-right">
                ...
                >
                  <rect
                    ...
                    height="35.318"
                    rx="8.409"
                    transform="rotate(-180 36.16 36.16)"
                    stroke="#A4A8BD"
                    stroke-width="1.682"
                  />
                  <path
                    d="M15 13.443l4.722 4.722L15 22.887 16.113 24l5.278-5.278a.787.787 0 000-1.113l-5.278-5.278L15 13.443z"
                    fill="#A4A8BD"
                  />
                </svg>
              </button>
